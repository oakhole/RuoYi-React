...
const hostColumns: ColumnsType<JvmInfoType> = [
  {
    title: 'col1',
    dataIndex: 'col1',
    key: 'col1',
      ...
      <Row gutter={[24, 24]}>
        <Col span={12}>
          <Card title="CPU" className={styles.card}>
            <Table pagination={false} dataSource={cpuData} columns={columns} />
          </Card>
        </Col>
        <Col span={12}>
          <Card title="内存" className={styles.card}>
            <Table pagination={false} dataSource={memData} columns={memColumns} />
          </Card>
        </Col>
      </Row>
      <Row gutter={[16, 16]}>
